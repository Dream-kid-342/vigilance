  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: hovered
          ? `0 24px 48px rgba(0,0,0,0.5), 0 0 28px ${accent}30`
          : t.shadowLg,
        cursor: 'default',
        flex: 1,
      }}
    >
      ...
      <span style={{
        ...
        background: `${accent}20`, color: accent, width: 'fit-content',
...
/* ── MAIN COMPONENT ──────────────────────────────────────── */
export default function LandingPage({ onEnterClient, onEnterWorker, onSignIn }) {
    ...
    <div style={{ minHeight: '100vh', background: t.bg, color: t.text, overflowX: 'hidden', position: 'relative' }}>
      ...
      <nav className="mobile-nav" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          <img src={logoImg} alt="Vigilance Logo" style={{ height: '36px', borderRadius: '8px' }} />
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          <ThemeToggle />
          <button
            id="nav-client-signin"
            onClick={onSignIn || onEnterClient}
            style={{
      ...
      {/* ── HERO ───────────────────────────────────────────── */}
      <section className="mobile-px mobile-py" style={{ position: 'relative', padding: '6rem 2rem 5rem', maxWidth: 1200, margin: '0 auto', textAlign: 'center', overflow: 'hidden' }}>
        {/* orbs */}
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <h1 style={{
            ...
            Connect with{' '}
            <span style={{
              background: 'linear-gradient(135deg, #3b82f6 0%, #818cf8 60%, #10b981 100%)',
              WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent',
              backgroundClip: 'text',
            }}>
          ...
          <p style={{
            fontSize: 'clamp(1rem, 2vw, 1.2rem)', color: t.textMuted,
          ...
          <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap', marginBottom: '1rem' }}>
            ...
            <button
              ...
              style={{
                ...
                color: '#10b981', border: '2px solid rgba(16,185,129,0.35)',
                fontSize: '1rem', fontWeight: 700, cursor: 'pointer',
                fontFamily: 'inherit', transition: 'all 0.2s',
              }}
          ...
          <p style={{ fontSize: '0.78rem', color: t.textSubtle }}>
            Free to join • No hidden fees • M-Pesa payments
          </p>
        </div>
      </section>
      ...
      {/* ── WHAT IS VIGILANCE ──────────────────────────────── */}
      <section className="mobile-px mobile-py" style={{ maxWidth: 1100, margin: '0 auto', padding: '5rem 2rem' }}>
        <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
          ...
          <h2 style={{ fontSize: 'clamp(1.7rem, 4vw, 2.4rem)', fontWeight: 800, marginBottom: '1rem', letterSpacing: '-0.02em' }}>
            What is Vigilance?
          </h2>
      ...
      <div style={{ background: t.surfaceAlt, borderTop: `1px solid ${t.border}`, borderBottom: `1px solid ${t.border}` }}>
        <section className="mobile-px mobile-py" style={{ maxWidth: 1100, margin: '0 auto', padding: '5rem 2rem' }}>
          <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
            ...
            <h2 style={{ fontSize: 'clamp(1.7rem, 4vw, 2.4rem)', fontWeight: 800, marginBottom: '0.75rem', letterSpacing: '-0.02em' }}>
              Who are you?
            </h2>
            <p style={{ color: t.textMuted, fontSize: '0.9rem' }}>
              Choose your path — everything is tailored to your specific experience.
            </p>
          </div>
      ...
      <section className="mobile-px mobile-py" style={{ maxWidth: 1100, margin: '0 auto', padding: '5rem 2rem' }}>
        <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
          ...
          <h2 style={{ fontSize: 'clamp(1.7rem, 4vw, 2.4rem)', fontWeight: 800, letterSpacing: '-0.02em' }}>
            How it works
          </h2>
        </div>
      ...
      <div style={{ background: t.surfaceAlt, borderTop: `1px solid ${t.border}` }}>
        <section className="mobile-px mobile-py" style={{ maxWidth: 900, margin: '0 auto', padding: '4rem 2rem', textAlign: 'center' }}>
          <h2 style={{ fontSize: 'clamp(1.5rem, 3.5vw, 2rem)', fontWeight: 800, marginBottom: '0.75rem', letterSpacing: '-0.02em' }}>
      ...
      {/* ── FINAL CTA ──────────────────────────────────────── */}
      <section className="mobile-px mobile-py" style={{ maxWidth: 800, margin: '0 auto', padding: '5rem 2rem', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          <h2 style={{ fontSize: 'clamp(1.7rem, 4vw, 2.5rem)', fontWeight: 800, marginBottom: '0.75rem', letterSpacing: '-0.02em' }}>
            Ready to get started?
          </h2>
          <p style={{ color: t.textMuted, fontSize: '0.95rem', marginBottom: '2.5rem', lineHeight: 1.7 }}>
            Join thousands of Kenyans already using Vigilance to work smarter and hire better.
      ...
      {/* ── FOOTER ─────────────────────────────────────────── */}
      <footer className="mobile-px mobile-stack mobile-text-center" style={{
        borderTop: `1px solid ${t.border}`,
        padding: '1.5rem 2rem',
        display: 'flex', alignItems: 'center', justifyContent: 'space-between',
        flexWrap: 'wrap', gap: '1rem',
        color: t.textSubtle, fontSize: '0.8rem',
      }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
          <img src={logoImg} alt="Vigilance Logo" style={{ height: '28px', borderRadius: '6px' }} />
